...
import { loadDocumentUser, loadSearchDocumentUser, deleteDocumentUser } from '../../store/actions/DocumentAction'
...
DeleteDocument = (e, code) => {
    ...
    if (confirmDialog == true) {
        this.props.deleteDocumentUser(code);
    } else {
  ...
  loadaddpage = (e) => {
    this.props.history.push('/Dashboardprofessor/Adddocument/'+this.props.match.params.id);
  }
  render() {
                  ...
                  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <div class="row m-0">
                      <div class="col-lg-4 document bg-white pt-3">
                        ...
                        <Link to="#" class="btn btn-success btn-sm w-100 mt-2 mb-3" onClick={(e) => this.loadaddpage()}><i class="fa fa-plus" aria-hidden="true"></i> File Upload</Link>
...
return {
	...
	deleteDocumentUser: (code) => dispatch(deleteDocumentUser(code))
}
}
