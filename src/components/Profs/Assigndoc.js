...
import { addDocumentDuty } from '../../store/actions/DocumentDutyAction'


class Assigndoc extends Component {
    ...
    constructor(props) {
      ...
      handleSubmit = (e) => {
        e.preventDefault();
        console.log(this.state);
        this.props.addDocumentDuty(this.state)
      }
    render() {
        const { documentDutyResponse } = this.props;
    return (
      <div>
                            ...
                            <div class="row d-flex">
                                ...
                                <div class="col-lg-6">
                                    <div class="card2 card border-0 px-4 py-5">
                                        ...
                                        <b>{documentDutyResponse != null ? documentDutyResponse : null}</b>
...
return {
    addDocumentDuty: (creds) => dispatch(addDocumentDuty(creds))
}
}

const mapStateToProps = (state) => {
return {
  documentDutyResponse: state.documentduty.documentDutyResponse
}
}
const style = {
display: 'flex',
...
export default connect(mapStateToProps, mapDisPatchToProps)(Assigndoc)
