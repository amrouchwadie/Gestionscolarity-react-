...
getNameModule = (e,id) =>{
  ...
  handleSubmit = (e) => {
    const coursee={
      ...
      title_course:this.state.title_course,
      code_filiere:this.state.code_filiere,
      code_niveau : this.state.code_niveau,
      visibility_course:this.state.visibility_course
    }
    e.preventDefault();
    console.log(this.state);
    this.props.addCourse(coursee)
  }

  render() {
    const { courseResponse } = this.props;
    return (
        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                         ...
                         <h4 style={{textAlign: 'center'}}> Add New Course</h4>
                    <div className="line" style={{alignSelf:"center"}}></div>
                     <label class="mb-1">
                            <h6 class="mb-0 text-sm">Name</h6>
                        </label> <input class="mb-4" type="text" name="title_course" placeholder="Enter a valid Name" id ="title_course"  onChange={this.handleChange}/>
                  ...
                  <label for="inputEmail4">Visibility of The Course</label>
                  <select type="none" className="custom-select" id="visibility_course" name="visibility_course" onChange={this.handleChange} required >
                  <option ></option>
                      ...
                      <b>{courseResponse != null ? courseResponse : null}</b>

                     </div>
            </div>
        </div>
        <div class="bg-blue py-4">
            <div class="row px-3"> <small class="ml-4 ml-sm-5 mb-2">Add New Course</small>
...
return {
  addCourse: (creds) => dispatch(addCourse(creds)),
...
return {
  courseResponse: state.course.courseResponse
}
}
const style = {
display: 'flex',
...
export default connect(mapStateToProps, mapDisPatchToProps)(MCourses)
