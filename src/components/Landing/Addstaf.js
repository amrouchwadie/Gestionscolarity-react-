...
import { addDirectorUser } from '../../store/actions/DirectorAction'


export class Addstaf extends Component {
    constructor(props) {
        super(props)
        this.state = {
            firstname: '',
    ...
    handleSubmit = (e) => {
        ...
        this.props.addDirectorUser(this.state);
    }
    fileTransform = (e) => {
                ...
                <form autoComplete="off" onSubmit={this.handleSubmit} >
                    ...
                    <div class="wrapper fadeInDown">
                        <div id="formContent">
                            ...
                            <h2 class="active"> Assign Staff </h2>
...
const mapDisPatchToProps = (dispatch) => {
    return {
        addDirectorUser: (creds) => dispatch(addDirectorUser(creds))
    }
}
...
export default connect(mapStateToProps, mapDisPatchToProps)(Addstaf)
