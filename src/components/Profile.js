...
class Profile extends Component {
    ...
    componentDidMount = () => {
        ...
        axios.get('http://127.0.0.1:8000/api/countStudent')
          ...
          axios.get('http://127.0.0.1:8000/api/countProfessor')
          .then(response => {
            this.setState({ nbrprof : response.data });
            
          });
          axios.get('http://127.0.0.1:8000/api/countFiliere')
          .then(response => {
            this.setState({ nbrbranch : response.data });
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card-box bg-green">
                <div class="inner">
                    <h3> {this.state.nbrprof} </h3>
                    <p style={{color:"black",fontSize:"18px"}}> Professors </p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="card-box bg-orange">
                <div class="inner">
                    <h3> {this.state.nbrbranch} </h3>
                    <p style={{color:"black",fontSize:"18px"}}> Branch </p>
                </div>
                <div class="icon">
