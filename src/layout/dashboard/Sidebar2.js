    ...
    return (
        <div >
            ...
            <div class="sidebar">
                ...
                <Link to="/dashboardprofessor/Home"><i class="fas fa-desktop"></i><span>Dashboard</span></Link>
                <Link to="/dashboardprofessor/Assign"><i class="fas fa-cogs"></i><span>Assignement</span></Link>
                <Link to="/dashboardprofessor/Courses"><i class="fas fa-table"></i><span>Courses</span></Link>
                <Link to="/dashboardprofessor/Courses"><i class="fas fa-th"></i><span>Exams</span></Link>
                <Link to="/dashboardprofessor/Courses"><i class="fas fa-info-circle"></i><span>Student</span></Link>
                <Link to="/dashboardprofessor/Library"><i class="fas fa-info-circle"></i><span>Library</span></Link>
                <Link to="/dashboardprofessor/ProfileDirector"><i class="fas fa-sliders-h"></i><span>Settings</span></Link>
            </div>
